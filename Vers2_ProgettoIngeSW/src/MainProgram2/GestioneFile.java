...
//	private static File file = new File("C:\\Users\\michela\\workspace\\ProvaXML\\prova_xml.xml");
	...
	public  static void objToXml(ArchivioReti arch) {
		...
		try {
			contextObj = JAXBContext.newInstance(ArchivioReti.class, Rete.class, RetePN.class, RelazioneDiFlusso.class, RelazionePN.class);
	...
	public static ArchivioReti xmlToObj(File file) {
		...
		try {
			 contextObj = JAXBContext.newInstance(ArchivioReti.class, Rete.class, RetePN.class);
